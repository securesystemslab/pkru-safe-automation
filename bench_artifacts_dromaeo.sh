...
${SOURCES}/run_artifacts_dromaeo.sh -t alloc
mv ${BENCH_RESULTS_DEFAULT} $BASE_PATH/vanilla-dromaeo-bench-results
...
${SOURCES}/run_artifacts_dromaeo.sh -t alloc
mv ${BENCH_RESULTS_DEFAULT} $BASE_PATH/mpk-dromaeo-bench-results
...
# Run benchmarking script for mpk
${SOURCES}/run_artifacts_dromaeo.sh -t alloc
mv ${BENCH_RESULTS_DEFAULT} $BASE_PATH/no-mpk-dromaeo-bench-results
